<template>
  ...
  <div class="body_container">
    <div v-if="!pageToSuccess" class="pageunLoad">
    ...
    <el-container class="el-container" v-else>
      ...
      <el-aside :width="isCollapse ? '64px' : '250px'" class="el-aside">
        <el-menu
          ...
          <!--logo-->
          <div id="title" :style="{color: theme}">
            <span v-if="!isCollapse">Autumn Office</span>
            <span v-else><i class="fa fa-coffee"/></span>
          </div>
          ...
          <el-submenu :index="index + ''"
                      ...
                      v-if="!item.hidden">
            <template slot="title">
              <i :class="item.iconCls" style="margin-right: 10px"/>
              <span>{{item.name}}</span>
            </template>
            <el-menu-item
              ...
              <i :class="children.iconCls" style="margin-right: 10px"/>
      ...
      <el-container class="el-container">
        <!--头部-->
        <el-header class="el_header" height="60px">
          <!--头部左侧图标li-->
          <ul class="header_left_ul">
            <li :title="isCollapse ? '展开菜单' : '收起菜单'" @click="changeMenu">
          ...
          <ul class="header_right_ul">
            ...
            <li class="throwLiStyle" style="width: 100px">
              <el-dropdown @command="handleCommand">
                <div class="el-dropdown-link">
                  <!--用户头像 src默认未加载图片路径-->
                  <el-avatar :size="30" src="" @error="errorHandler" class="user_Face">
